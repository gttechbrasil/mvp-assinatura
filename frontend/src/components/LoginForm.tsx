    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 select-none">
      ...
      <div className="flex flex-col">
        <div className="flex justify-between items-center mb-1.5">
          <label className="text-xs font-medium text-text-muted" htmlFor="password-input">
            Senha
          </label>
          <button
            type="button"
            className="text-xs text-text-soft hover:text-text-main hover:underline cursor-pointer transition-colors"
